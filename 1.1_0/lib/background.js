...
/***/ function(module, exports, __webpack_require__) {
	...
	var _difference = __webpack_require__(1);

	var _difference2 = _interopRequireDefault(_difference);

	var _intersection = __webpack_require__(51);
	...
	chrome.runtime.onMessage.addListener(function (request) {
	  ...
	  var nextUsers = request.users;
	  var nextThreads = request.threads;

	  chrome.storage.local.get('store', function (_ref) {
	    var _ref$store = _ref.store;
	    var store = _ref$store === undefined ? '{}' : _ref$store;

	    var storeData = JSON.parse(store);
	    var _storeData$state = storeData.state;
	    var currState = _storeData$state === undefined ? {} : _storeData$state;
	    var _storeData$users = storeData.users;
	    var currUsers = _storeData$users === undefined ? {} : _storeData$users;
	    var _storeData$threads = storeData.threads;
	    var currThreads = _storeData$threads === undefined ? {} : _storeData$threads;
	    var _storeData$actions = storeData.actions;
	    var actions = _storeData$actions === undefined ? [] : _storeData$actions;

	    var currStateKeys = Object.keys(currState);
	    var nextStateKeys = Object.keys(nextState);
	    var removedKeys = (0, _difference2.default)(currStateKeys, nextStateKeys);
	    var addedKeys = (0, _difference2.default)(nextStateKeys, currStateKeys);
	    var otherKeys = (0, _intersection2.default)(currStateKeys, nextStateKeys);

	    var newActions = [];

	    newActions = newActions.concat.apply(newActions, removedKeys.map(function (key) {
	      return currState[key].map(function (fbid) {
	        return {
	          user: currUsers[(0, _getUserId2.default)(fbid)],
	    ...
	    newActions = newActions.concat.apply(newActions, addedKeys.map(function (key) {
	      return nextState[key].map(function (fbid) {
	        return {
	          user: nextUsers[(0, _getUserId2.default)(fbid)],
	    ...
	    newActions = newActions.concat.apply(newActions, otherKeys.map(function (key) {
	      var removedUsers = (0, _difference2.default)(currState[key], nextState[key]);
	      var addedUsers = (0, _difference2.default)(nextState[key], currState[key]);

	      return removedUsers.map(function (fbid) {
	        return {
	          user: currUsers[(0, _getUserId2.default)(fbid)],
	          thread: currThreads[key],
	          type: 'stopped_typing',
	      ...
	      }).concat(addedUsers.map(function (fbid) {
	        return {
	          user: nextUsers[(0, _getUserId2.default)(fbid)],
	          thread: nextThreads[key],
	          type: 'started_typing',
	    ...
	    if (newActions.length > 0) {
	      chrome.storage.local.set({
	        store: JSON.stringify(_extends({}, storeData, {
	          users: nextUsers,
	          state: nextState,
	          threads: nextThreads,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseDifference = __webpack_require__(2),
	    baseFlatten = __webpack_require__(38),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MapCache = __webpack_require__(4),
	    cachePush = __webpack_require__(30);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapClear = __webpack_require__(5),
	    mapDelete = __webpack_require__(15),
	    mapGet = __webpack_require__(22),
	    mapHas = __webpack_require__(25),
	    mapSet = __webpack_require__(27);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Map = __webpack_require__(14),
	    assocGet = __webpack_require__(23),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Map = __webpack_require__(14),
	    assocHas = __webpack_require__(26),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayMap = __webpack_require__(35),
	    baseIntersection = __webpack_require__(52),
	    rest = __webpack_require__(47),
	    toArrayLikeObject = __webpack_require__(53);
